...
// The Teams bot's channel-agnostic "brain" -- account linking, RAG chat,
// and create/update task/project/file via tool-calling. Extracted out of
// app/api/teams/bot/[companyId]/route.ts so both messaging endpoints
// (that BYO-credentials route, and app/api/teams/bot/shared/route.ts's
// single endpoint for companies using Diract's own shared bot) can call
// the exact same logic -- neither this file nor lib/ai/* care which
