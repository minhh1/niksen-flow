  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <p className="text-sm text-slate-400 mb-10">Flow — Management Central · Last updated: July 2026</p>
        ...
        <div className="prose prose-slate prose-sm max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">Flow is an internal property and legal management tool operated by Niksen Time Pty Ltd and Huynh Lawyers. This policy explains how we collect and use information when you use the Flow Gmail Add-on and web application.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">When you connect your Gmail account to Flow, we access email metadata (subject lines, sender addresses, dates, message IDs), Gmail labels, and email content — but only for emails you explicitly assign to a project. We do not read, store, or process any other emails.</p>
            <h3 className="text-sm font-medium text-slate-700 mt-3 mb-1">Account Information</h3>
            <p className="text-slate-600 leading-relaxed">Your Google account email address and your company membership role within Flow.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-slate-600 space-y-1">
              ...
              <li>To display project-related emails within the Flow web application</li>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">We do not sell, rent, or share your personal information with third parties. Email data is shared only with other authorised members of your company within Flow.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">You may disconnect your Gmail account from Flow at any time via application settings, request deletion of your data by contacting us, or revoke Flow's Gmail access via <a href="https://myaccount.google.com" className="text-indigo-600 hover:underline">myaccount.google.com</a>.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">Google API Services</h2>
            <p className="text-slate-600 leading-relaxed">Flow's use of Google APIs complies with the <a href="https://developers.google.com/terms/api-services-user-data-policy" className="text-indigo-600 hover:underline">Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
          </section>
