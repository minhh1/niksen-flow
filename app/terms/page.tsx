    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-slate-600 text-sm leading-relaxed">
          ...
          {[
            { title: "1. Acceptance of Terms", body: "By accessing or using the Flow application, including the Gmail Add-on, you agree to be bound by these Terms of Service. If you do not agree, do not use the App." },
            { title: "2. Eligibility", body: "The App is intended for use by authorised employees and contractors of Niksen Time Pty Ltd and Huynh Lawyers. Access is granted by your company administrator." },
            ...
            { title: "4. Gmail Integration", body: "By connecting your Gmail account, you authorise Flow to create and manage Gmail labels, read metadata and content of emails you assign to projects, and sync changes across your team. You may revoke this access at any time via your Google Account settings." },
            ...
            { title: "6. Intellectual Property", body: "All content, code, and features of the App are the property of Niksen Time Pty Ltd. You may not copy or distribute any part of the App without prior written consent." },
